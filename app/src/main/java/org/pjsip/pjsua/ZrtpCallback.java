...
public class ZrtpCallback {
    ...
    public void on_zrtp_show_sas(int call_id, pj_str_t sas, int verified) {
        if (getClass() == ZrtpCallback.class)
            pjsuaJNI.ZrtpCallback_on_zrtp_show_sas(swigCPtr, this, call_id, pj_str_t.getCPtr(sas), sas, verified);
        else
            pjsuaJNI.ZrtpCallback_on_zrtp_show_sasSwigExplicitZrtpCallback(swigCPtr, this, call_id, pj_str_t.getCPtr(sas), sas, verified);
    }

    public void on_zrtp_update_transport(int call_id) {
        if (getClass() == ZrtpCallback.class)
            pjsuaJNI.ZrtpCallback_on_zrtp_update_transport(swigCPtr, this, call_id);
        else
            pjsuaJNI.ZrtpCallback_on_zrtp_update_transportSwigExplicitZrtpCallback(swigCPtr, this, call_id);
    }
