...
public class EarlyLockCallback {
    ...
    public void on_create_early_lock() {
        if (getClass() == EarlyLockCallback.class)
            pjsuaJNI.EarlyLockCallback_on_create_early_lock(swigCPtr, this);
        else
            pjsuaJNI.EarlyLockCallback_on_create_early_lockSwigExplicitEarlyLockCallback(swigCPtr, this);
    }
