...
public class MobileRegHandlerCallback {
    ...
    public void on_save_contact(int acc_id, pj_str_t contact, int expires) {
        if (getClass() == MobileRegHandlerCallback.class)
            pjsuaJNI.MobileRegHandlerCallback_on_save_contact(swigCPtr, this, acc_id, pj_str_t.getCPtr(contact), contact, expires);
        else
            pjsuaJNI.MobileRegHandlerCallback_on_save_contactSwigExplicitMobileRegHandlerCallback(swigCPtr, this, acc_id, pj_str_t.getCPtr(contact), contact, expires);
    }
